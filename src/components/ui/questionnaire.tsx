  ...
  return (
    <QuestionnairePrimitive.Item
      ...
      className={cn(
        ...
        "[&_[data-slot=questionnaire-choices]]:mt-1",
        "[&_[data-slot=questionnaire-error]]:mt-0",
        className,
      )}
      {...props}
    />
...
function QuestionnaireTitle({
  ...
  return (
    <QuestionnairePrimitive.Title
      ...
      className={cn(
        "font-heading text-base leading-snug font-semibold text-pretty text-foreground [&:not(:has(~[data-slot=questionnaire-description]))]:mb-2",
        className,
      )}
      {...props}
    />
