...
/** Turkuaz CSS mark: Danube lowercase “t” as outlined paths. */
export function TurkuazMark({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 109 162" aria-hidden className={cn("shrink-0", className)} {...props}>
      <g transform="translate(0 162) scale(0.1 -0.1)" stroke="none" fill="currentColor">
